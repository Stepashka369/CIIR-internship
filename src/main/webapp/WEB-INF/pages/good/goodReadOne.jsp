...
<h2>Product: <%= good.getName() %></h2>
<p>Model: <%= good.getModel() %></p>
<p>Manufacturer: <%= good.getManufacturer().getName() %></p>
<p>Guarantee: <%= good.getGuarantee() %></p>
<p>Price: <%= good.getPrice() %></p>
<p>Description: <%= good.getDescription() %></p>
